const competitions = [
  ...
  {
    name: 'Poem Writing Competition',
    role: '',
  },
  {
    name: 'Poem Recitation Competition',
    role: '',
  },
  {
  ...
  {
    name: 'Literary Olympiad Competition',
    role: '',
  },
  {
...
const updateInfo = (slideNumber) => {
  const member = competitions[slideNumber - 1]
